...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n/* harmony import */ var _swiper_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./swiper.min.js */ \"./src/js/swiper.min.js\");\n/* harmony import */ var _swiper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./swiper.js */ \"./src/js/swiper.js\");\n/* harmony import */ var _nouislider_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./nouislider.js */ \"./src/js/nouislider.js\");\n/* harmony import */ var _changeofposition_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./changeofposition.js */ \"./src/js/changeofposition.js\");\n/* harmony import */ var _graph_accordion_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./graph-accordion.js */ \"./src/js/graph-accordion.js\");\n/* harmony import */ var _form_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./form.js */ \"./src/js/form.js\");\n/* harmony import */ var _scroll_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./scroll.js */ \"./src/js/scroll.js\");\n/* harmony import */ var _catalog_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./catalog.js */ \"./src/js/catalog.js\");\n/* harmony import */ var _popup_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./popup.js */ \"./src/js/popup.js\");\n/* harmony import */ var _animation_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./animation.js */ \"./src/js/animation.js\");\n/* harmony import */ var _filter_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./filter.js */ \"./src/js/filter.js\");\n/* harmony import */ var _catalogfilter_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./catalogfilter.js */ \"./src/js/catalogfilter.js\");\n/* harmony import */ var _menu_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./menu.js */ \"./src/js/menu.js\");\n/* harmony import */ var _burger_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./burger.js */ \"./src/js/burger.js\");\n\r\n\r\n\r\n\r\n\r\n// import \"./progress.js\";\r\n\r\n// import \"./portfolio-tabs.js\";\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n// Реализация бургер-меню\r\n\r\n\r\n\r\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\r\n\n\n//# sourceURL=webpack://gulp/./src/js/app.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\nconst catalog = document.querySelectorAll('.catalog-main__list');\r\nconst catalogBtn = document.querySelectorAll('.catalog-main__btn');\r\nconst catalogItem = document.querySelectorAll('.catalog-main__item');\r\nconst catalogItems = document.querySelectorAll('.article__items');\r\nconst articleVisible = document.querySelectorAll('.article__items--visible');\r\nconst teg = document.querySelector('.teg');\r\nconst tegItem = document.querySelector('.teg__item');\r\nconst tegClose = document.querySelectorAll('.teg__close');\r\nconst customSelect = document.querySelectorAll('.custom-select');\r\n\r\n\r\nconst createTeg = (text) => {\r\n    return (\r\n        `\r\n            <button class=\"teg__close btn-reset\" data-text=\"${text}\">\r\n                ${text}\r\n                <svg>\r\n                    <use xlink:href=\"#close\"/>\r\n                </svg>\r\n            </button>\r\n        `\r\n    );\r\n};\r\n\r\n\r\nif (catalogItems) {\r\n    catalogItems.forEach (el => {\r\n        el.closest('.article__items').classList.add('article__items--visible-more');\r\n    });\r\n    if(catalog) {\r\n        catalog.forEach (el =>{\r\n            el.addEventListener('click', (e) => {\r\n                const target = e.target;\r\n            \r\n                if (target.classList.contains('catalog-main__btn')) {\r\n                    const path = target.dataset.path;\r\n                    target.classList.toggle('catalog-main__btn--active')\r\n                    if(target.classList.contains('catalog-main__btn--active')) {\r\n                        let text = target.textContent;\r\n                        teg.insertAdjacentHTML('afterbegin', createTeg(text));\r\n            \r\n    \r\n                        document.querySelectorAll(`[data-target=\"${path}\"]`).forEach(el => {\r\n                            el.closest('.article__items').classList.add('article__items--visible');\r\n                        });\r\n                        catalogItems.forEach (el => {\r\n                            el.closest('.article__items').classList.remove('article__items--visible-more');\r\n                        });\r\n                    } else {\r\n                        document.querySelectorAll(`[data-target=\"${path}\"]`).forEach(el => {\r\n                            el.closest('.article__items').classList.remove('article__items--visible');\r\n                        });\r\n    \r\n                        let text = target.textContent;\r\n                        document.querySelector(`[data-text=\"${text}\"]`).remove();\r\n                    }\r\n                    let a = 0;\r\n                    for (let item of catalogItems) {\r\n                        if (item.matches('.article__items--visible')) {\r\n                            a++;\r\n                        }\r\n                    }\r\n                    if (a==0) {\r\n                        catalogItems.forEach (el => {\r\n                            el.closest('.article__items').classList.add('article__items--visible-more');\r\n                        });\r\n                    }\r\n                    teg.addEventListener('click', (e) => {\r\n                        const trg = e.target;\r\n                        if (e.target.classList.contains('teg__close'))\r\n                        {\r\n                            e.target.remove();\r\n                            let text = trg.textContent.trim();\r\n                            document.querySelectorAll(`[data-tx=\"${text}\"]`).forEach(el => {\r\n                                el.classList.remove('catalog-main__btn--active');\r\n                            });\r\n                        }\r\n                        if(target.classList.contains('catalog-main__btn--active')) {\r\n                            document.querySelectorAll(`[data-target=\"${path}\"]`).forEach(el => {\r\n                                el.closest('.article__items').classList.add('article__items--visible');\r\n                            });\r\n                            catalogItems.forEach (el => {\r\n                                el.closest('.article__items').classList.remove('article__items--visible-more');\r\n                            });\r\n                        } else {\r\n                            document.querySelectorAll(`[data-target=\"${path}\"]`).forEach(el => {\r\n                                el.closest('.article__items').classList.remove('article__items--visible');\r\n                            });\r\n                        }\r\n                        let b = 0;\r\n                        for (let item of catalogItems) {\r\n                            if (item.matches('.article__items--visible')) {\r\n                                b++;\r\n                            }\r\n                        }\r\n                        if (b==0) {\r\n                            catalogItems.forEach (el => {\r\n                                el.closest('.article__items').classList.add('article__items--visible-more');\r\n                            });\r\n                        }\r\n                    });\r\n                }\r\n            });\r\n        })\r\n    };  \r\n};\r\n\r\n\r\nif(customSelect) {\r\n    customSelect.forEach(el => {\r\n        el.addEventListener('click', (e) => {\r\n            e.currentTarget.classList.toggle('custom-select--open');\r\n            e.stopPropagation();\r\n            if (e.target.classList.contains('custom-select__value')) {\r\n                let text = e.target.textContent;\r\n                e.currentTarget.querySelector('.custom-select__top').textContent = text;\r\n            }\r\n        });\r\n        document.addEventListener('click', (e) => {\r\n            if (e.target !== customSelect) {\r\n                document.querySelector('.custom-select').classList.remove('custom-select--open'); \r\n            }\r\n        });\r\n    \r\n        document.addEventListener('keydown', (e) => {\r\n            if (e.key === 'Tab' || e.key === 'Escape') {\r\n                document.querySelector('.custom-select').classList.remove('custom-select--open');\r\n            }\r\n        });\r\n    });\r\n}\r\n\r\n\n\n//# sourceURL=webpack://gulp/./src/js/catalog.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n//весь фильтер checkbox\r\nconst filter = document.querySelector('.filter');\r\n\r\nif (filter) {\r\n    const catalogItems = document.querySelectorAll('.article__items');\r\n    const btn = document.querySelectorAll('.filter__reset');\r\n    //все чекбоксы\r\n    const checkbox = document.querySelectorAll('.filter__checkbox');\r\n\r\n    const checboxes = [];\r\n    const checboxesOne = [];\r\n    const checboxesTwo = [];\r\n    const checboxesThree = [];\r\n    const checboxesFour = [];\r\n\r\n\r\n\r\n    for (let i=0; i<checkbox.length; i++) {\r\n        checboxes.push(checkbox[i]);\r\n    }\r\n\r\n    const filterItemOne = document.querySelectorAll('.filter__item--one');\r\n    filterItemOne.forEach(el=> {\r\n        const checkboxOne = el.querySelectorAll('.filter__checkbox');\r\n        for (let i=0; i<checkboxOne.length; i++) {\r\n            checboxesOne.push(checkboxOne[i]);\r\n        }\r\n    });\r\n\r\n    const filterItemTwo = document.querySelectorAll('.filter__item--two')\r\n    filterItemTwo.forEach(el=> {\r\n        const checkboxTwo = el.querySelectorAll('.filter__checkbox');\r\n        for (let i=0; i<checkboxTwo.length; i++) {\r\n            checboxesTwo.push(checkboxTwo[i]);\r\n        }\r\n    });\r\n\r\n    const filterItemThree = document.querySelectorAll('.filter__item--three')\r\n    filterItemThree.forEach(el=> {\r\n        const checkboxThree = el.querySelectorAll('.filter__checkbox');\r\n        for (let i=0; i<checkboxThree.length; i++) {\r\n            checboxesThree.push(checkboxThree[i]);\r\n        }\r\n    });\r\n\r\n    const filterItemFour = document.querySelectorAll('.filter__item--four')\r\n    filterItemFour.forEach(el=> {\r\n        const checkboxFour = el.querySelectorAll('.filter__checkbox');\r\n        for (let i=0; i<checkboxFour.length; i++) {\r\n            checboxesFour.push(checkboxFour[i]);\r\n        }\r\n    });\r\n\r\n\r\n\r\n    for (let i=0; i<checboxesOne.length;i++) {\r\n        checboxesOne[i].addEventListener('change', (e) => {\r\n            const dataLight = e.target;\r\n            const dataLig = dataLight.dataset.lig;\r\n            if(checboxesOne[i].checked) {\r\n                document.querySelectorAll(`[data-light=\"${dataLig}\"]`).forEach(el => {\r\n                    el.closest('.article__items').classList.add('article__items--light');\r\n                });\r\n            } else {\r\n                document.querySelectorAll(`[data-light=\"${dataLig}\"]`).forEach(el => {\r\n                    el.closest('.article__items').classList.remove('article__items--light');\r\n                });\r\n            }\r\n        });\r\n    }\r\n\r\n    for (let i=0; i<checboxesTwo.length;i++) {\r\n        checboxesTwo[i].addEventListener('change', (e) => {\r\n            const dataColor = e.target;\r\n            const dataCol = dataColor.dataset.col;\r\n            if(checboxesTwo[i].checked) {\r\n                document.querySelectorAll(`[data-color=\"${dataCol}\"]`).forEach(el => {\r\n                    el.closest('.article__items').classList.add('article__items--color');\r\n                });\r\n            } else {\r\n                document.querySelectorAll(`[data-color=\"${dataCol}\"]`).forEach(el => {\r\n                    el.closest('.article__items').classList.remove('article__items--color');\r\n                });\r\n            }\r\n        });\r\n    }\r\n\r\n    for (let i=0; i<checboxesThree.length;i++) {\r\n        checboxesThree[i].addEventListener('change', (e) => {\r\n            const dataFormat = e.target;\r\n            const dataForm = dataFormat.dataset.form;\r\n            if(checboxesThree[i].checked) {\r\n                document.querySelectorAll(`[data-format=\"${dataForm}\"]`).forEach(el => {\r\n                    el.closest('.article__items').classList.add('article__items--format');\r\n                });\r\n            } else {\r\n                document.querySelectorAll(`[data-format=\"${dataForm}\"]`).forEach(el => {\r\n                    el.closest('.article__items').classList.remove('article__items--format');\r\n                });\r\n            }\r\n        });\r\n    }\r\n\r\n    for (let i=0; i<checboxesFour.length;i++) {\r\n        checboxesFour[i].addEventListener('change', (e) => {\r\n            const dataFlower = e.target;\r\n            const dataFlow = dataFlower.dataset.flow;\r\n            if(checboxesFour[i].checked) {\r\n                let a= 0;\r\n                document.querySelectorAll(`[data-flower=\"${dataFlow}\"]`).forEach(el => {\r\n                    a++;\r\n                    el.closest('.article__items').classList.add('article__items--flower');\r\n                });\r\n                console.log(a);\r\n            } else {\r\n                document.querySelectorAll(`[data-flower=\"${dataFlow}\"]`).forEach(el => {\r\n                    el.closest('.article__items').classList.remove('article__items--flower');\r\n                });\r\n            }\r\n        });\r\n    }\r\n\r\n    for (let i=0; i<checboxes.length;i++) {\r\n        checboxes[i].addEventListener('change', (e) => {\r\n            if(checboxes[i].checked) {\r\n                catalogItems.forEach (el => {\r\n                    el.closest('.article__items').classList.remove('article__items--visible-more');\r\n                });\r\n            } else {\r\n                let a = 0;\r\n                for (let i=0; i<checboxes.length;i++) {\r\n                    if(checboxes[i].checked) {\r\n                        a++\r\n                    }\r\n                }\r\n                if (a === 0) {\r\n                    catalogItems.forEach (el => {\r\n                        el.closest('.article__items').classList.add('article__items--visible-more');\r\n                    });\r\n                }\r\n            }\r\n        });\r\n    }\r\n\r\n    btn.forEach (el => {\r\n        el.addEventListener('click', () => {\r\n            for (let i=0; i<checkbox.length; i++) {\r\n                checboxes[i].checked = false;\r\n                catalogItems.forEach (el => {\r\n                    el.closest('.article__items').classList.add('article__items--visible-more');\r\n                    el.closest('.article__items').classList.remove('article__items--flower','article__items--format', 'article__items--color', 'article__items--light');\r\n                });\r\n            }\r\n        });\r\n    })\r\n    \r\n}\n\n//# sourceURL=webpack://gulp/./src/js/catalogfilter.js?");

/***/ }),

/***/ "./src/js/changeofposition.js":
/*!************************************!*\
  !*** ./src/js/changeofposition.js ***!
  \************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n\r\n\r\nfunction DynamicAdapt(type) {\r\n\tthis.type = type;\r\n}\r\n\r\nDynamicAdapt.prototype.init = function () {\r\n\tconst _this = this;\r\n\t// массив объектов\r\n\tthis.оbjects = [];\r\n\tthis.daClassname = \"_dynamic_adapt_\";\r\n\t// массив DOM-элементов\r\n\tthis.nodes = document.querySelectorAll(\"[data-da]\");\r\n\r\n\t// наполнение оbjects объктами\r\n\tfor (let i = 0; i < this.nodes.length; i++) {\r\n\t\tconst node = this.nodes[i];\r\n\t\tconst data = node.dataset.da.trim();\r\n\t\tconst dataArray = data.split(\",\");\r\n\t\tconst оbject = {};\r\n\t\tоbject.element = node;\r\n\t\tоbject.parent = node.parentNode;\r\n\t\tоbject.destination = document.querySelector(dataArray[0].trim());\r\n\t\tоbject.breakpoint = dataArray[1] ? dataArray[1].trim() : \"767\";\r\n\t\tоbject.place = dataArray[2] ? dataArray[2].trim() : \"last\";\r\n\t\tоbject.index = this.indexInParent(оbject.parent, оbject.element);\r\n\t\tthis.оbjects.push(оbject);\r\n\t}\r\n\r\n\tthis.arraySort(this.оbjects);\r\n\r\n\t// массив уникальных медиа-запросов\r\n\tthis.mediaQueries = Array.prototype.map.call(this.оbjects, function (item) {\r\n\t\treturn '(' + this.type + \"-width: \" + item.breakpoint + \"px),\" + item.breakpoint;\r\n\t}, this);\r\n\tthis.mediaQueries = Array.prototype.filter.call(this.mediaQueries, function (item, index, self) {\r\n\t\treturn Array.prototype.indexOf.call(self, item) === index;\r\n\t});\r\n\r\n\t// навешивание слушателя на медиа-запрос\r\n\t// и вызов обработчика при первом запуске\r\n\tfor (let i = 0; i < this.mediaQueries.length; i++) {\r\n\t\tconst media = this.mediaQueries[i];\r\n\t\tconst mediaSplit = String.prototype.split.call(media, ',');\r\n\t\tconst matchMedia = window.matchMedia(mediaSplit[0]);\r\n\t\tconst mediaBreakpoint = mediaSplit[1];\r\n\r\n\t\t// массив объектов с подходящим брейкпоинтом\r\n\t\tconst оbjectsFilter = Array.prototype.filter.call(this.оbjects, function (item) {\r\n\t\t\treturn item.breakpoint === mediaBreakpoint;\r\n\t\t});\r\n\t\tmatchMedia.addListener(function () {\r\n\t\t\t_this.mediaHandler(matchMedia, оbjectsFilter);\r\n\t\t});\r\n\t\tthis.mediaHandler(matchMedia, оbjectsFilter);\r\n\t}\r\n};\r\n\r\nDynamicAdapt.prototype.mediaHandler = function (matchMedia, оbjects) {\r\n\tif (matchMedia.matches) {\r\n\t\tfor (let i = 0; i < оbjects.length; i++) {\r\n\t\t\tconst оbject = оbjects[i];\r\n\t\t\tоbject.index = this.indexInParent(оbject.parent, оbject.element);\r\n\t\t\tthis.moveTo(оbject.place, оbject.element, оbject.destination);\r\n\t\t}\r\n\t} else {\r\n\t\tfor (let i = 0; i < оbjects.length; i++) {\r\n\t\t\tconst оbject = оbjects[i];\r\n\t\t\tif (оbject.element.classList.contains(this.daClassname)) {\r\n\t\t\t\tthis.moveBack(оbject.parent, оbject.element, оbject.index);\r\n\t\t\t}\r\n\t\t}\r\n\t}\r\n};\r\n\r\n// Функция перемещения\r\nDynamicAdapt.prototype.moveTo = function (place, element, destination) {\r\n\telement.classList.add(this.daClassname);\r\n\tif (place === 'last' || place >= destination.children.length) {\r\n\t\tdestination.insertAdjacentElement('beforeend', element);\r\n\t\treturn;\r\n\t}\r\n\tif (place === 'first') {\r\n\t\tdestination.insertAdjacentElement('afterbegin', element);\r\n\t\treturn;\r\n\t}\r\n\tdestination.children[place].insertAdjacentElement('beforebegin', element);\r\n}\r\n\r\n// Функция возврата\r\nDynamicAdapt.prototype.moveBack = function (parent, element, index) {\r\n\telement.classList.remove(this.daClassname);\r\n\tif (parent.children[index] !== undefined) {\r\n\t\tparent.children[index].insertAdjacentElement('beforebegin', element);\r\n\t} else {\r\n\t\tparent.insertAdjacentElement('beforeend', element);\r\n\t}\r\n}\r\n\r\n// Функция получения индекса внутри родителя\r\nDynamicAdapt.prototype.indexInParent = function (parent, element) {\r\n\tconst array = Array.prototype.slice.call(parent.children);\r\n\treturn Array.prototype.indexOf.call(array, element);\r\n};\r\n\r\n// Функция сортировки массива по breakpoint и place \r\n// по возрастанию для this.type = min\r\n// по убыванию для this.type = max\r\nDynamicAdapt.prototype.arraySort = function (arr) {\r\n\tif (this.type === \"min\") {\r\n\t\tArray.prototype.sort.call(arr, function (a, b) {\r\n\t\t\tif (a.breakpoint === b.breakpoint) {\r\n\t\t\t\tif (a.place === b.place) {\r\n\t\t\t\t\treturn 0;\r\n\t\t\t\t}\r\n\r\n\t\t\t\tif (a.place === \"first\" || b.place === \"last\") {\r\n\t\t\t\t\treturn -1;\r\n\t\t\t\t}\r\n\r\n\t\t\t\tif (a.place === \"last\" || b.place === \"first\") {\r\n\t\t\t\t\treturn 1;\r\n\t\t\t\t}\r\n\r\n\t\t\t\treturn a.place - b.place;\r\n\t\t\t}\r\n\r\n\t\t\treturn a.breakpoint - b.breakpoint;\r\n\t\t});\r\n\t} else {\r\n\t\tArray.prototype.sort.call(arr, function (a, b) {\r\n\t\t\tif (a.breakpoint === b.breakpoint) {\r\n\t\t\t\tif (a.place === b.place) {\r\n\t\t\t\t\treturn 0;\r\n\t\t\t\t}\r\n\r\n\t\t\t\tif (a.place === \"first\" || b.place === \"last\") {\r\n\t\t\t\t\treturn 1;\r\n\t\t\t\t}\r\n\r\n\t\t\t\tif (a.place === \"last\" || b.place === \"first\") {\r\n\t\t\t\t\treturn -1;\r\n\t\t\t\t}\r\n\r\n\t\t\t\treturn b.place - a.place;\r\n\t\t\t}\r\n\r\n\t\t\treturn b.breakpoint - a.breakpoint;\r\n\t\t});\r\n\t\treturn;\r\n\t}\r\n};\r\n\r\nconst da = new DynamicAdapt(\"max\");\r\nda.init();\n\n//# sourceURL=webpack://gulp/./src/js/changeofposition.js?");

/***/ }),

/***/ "./src/js/disable-scroll.js":
/*!**********************************!*\
  !*** ./src/js/disable-scroll.js ***!
  \**********************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"disableScroll\": () => (/* binding */ disableScroll)\n/* harmony export */ });\n/* harmony import */ var _vars_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_vars.js */ \"./src/js/_vars.js\");\n\r\n\r\nconst disableScroll = () => {\r\n  const fixBlocks = document?.querySelectorAll('.fixed-block');\r\n  const pagePosition = window.scrollY;\r\n  const paddingOffset = `${(window.innerWidth - _vars_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].bodyEl.offsetWidth)}px`;\r\n\r\n  _vars_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].htmlEl.style.scrollBehavior = 'none';\r\n  fixBlocks.forEach(el => { el.style.paddingRight = paddingOffset; });\r\n  _vars_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].bodyEl.style.paddingRight = paddingOffset;\r\n  _vars_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].bodyEl.classList.add('dis-scroll');\r\n  _vars_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].bodyEl.dataset.position = pagePosition;\r\n  _vars_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].bodyEl.style.top = `-${pagePosition}px`;\r\n}\n\n//# sourceURL=webpack://gulp/./src/js/disable-scroll.js?");

/***/ }),

/***/ "./src/js/enable-scroll.js":
/*!*********************************!*\
  !*** ./src/js/enable-scroll.js ***!
  \*********************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"enableScroll\": () => (/* binding */ enableScroll)\n/* harmony export */ });\n/* harmony import */ var _vars_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_vars.js */ \"./src/js/_vars.js\");\n\r\n\r\nconst enableScroll = () => {\r\n  const fixBlocks = document?.querySelectorAll('.fixed-block');\r\n  const body = document.body;\r\n  // const pagePosition = parseInt(vars.bodyEl.dataset.position, 10);\r\n  fixBlocks.forEach(el => { el.style.paddingRight = '0px'; });\r\n  _vars_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].bodyEl.style.paddingRight = '0px';\r\n\r\n  _vars_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].bodyEl.style.top = 'auto';\r\n  _vars_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].bodyEl.classList.remove('dis-scroll');\r\n  // window.scroll({\r\n  //   top: pagePosition,\r\n  //   left: 0\r\n  // });\r\n  _vars_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].bodyEl.removeAttribute('data-position');\r\n  _vars_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].htmlEl.style.scrollBehavior = 'smooth';\r\n}\n\n//# sourceURL=webpack://gulp/./src/js/enable-scroll.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\nconst menu = document.querySelector('.menu');\r\nif (menu) {\r\n    const menuTitle = document.querySelectorAll('.menu__title');\r\n    const filter= document.querySelector('.menu__filter');\r\n    const sort= document.querySelector('.menu__sort');\r\n    const catalog= document.querySelector('.menu__catalog');\r\n\r\n\r\n    menuTitle.forEach(el=> {\r\n        el.addEventListener('click', (e)=> {\r\n            if (e.target.textContent == 'фильтр товаров') {\r\n                filter.classList.toggle('menu__filter--active');\r\n            }\r\n            if (e.target.textContent == 'сортировка товаров') {\r\n                sort.classList.toggle('menu__sort--active');\r\n            }\r\n            if (e.target.textContent== 'категории') {\r\n                catalog.classList.toggle('menu__catalog--active');\r\n            }\r\n        })\r\n    })\r\n}\n\n//# sourceURL=webpack://gulp/./src/js/menu.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _disable_scroll_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./disable-scroll.js */ \"./src/js/disable-scroll.js\");\n/* harmony import */ var _enable_scroll_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./enable-scroll.js */ \"./src/js/enable-scroll.js\");\n\r\n\r\n\r\nconst popup = document.querySelectorAll('.popup');\r\nconst assortmentItem = document.querySelectorAll('.assortment-item');\r\nconst popupClose = document.querySelectorAll('.popup__close');\r\nconst areaClose = document.querySelectorAll('.popup__area');\r\n\r\n\r\n\r\nassortmentItem.forEach(el => {\r\n    el.addEventListener('click', (e) => {\r\n        const target = e.target;\r\n        if (target.classList.contains('assortment-item__image')) {\r\n            const path = target.dataset.path;\r\n            target.classList.toggle('assortment-item--active')\r\n            if(target.classList.contains('assortment-item--active')) {\r\n                document.querySelectorAll(`[data-target=\"${path}\"]`).forEach(el => {\r\n                    el.closest('.popup').classList.add('open');\r\n                    (0,_disable_scroll_js__WEBPACK_IMPORTED_MODULE_0__.disableScroll)();\r\n                });\r\n            } \r\n            popupClose.forEach(el => {\r\n                el.addEventListener('click', (e) => {\r\n                    const currentBtn = e.currentTarget;\r\n                    currentBtn.closest('.popup').classList.remove('open');\r\n                    (0,_enable_scroll_js__WEBPACK_IMPORTED_MODULE_1__.enableScroll)();\r\n                });\r\n            });\r\n            areaClose.forEach(el => {\r\n                el.addEventListener ('click', (e) => {\r\n                    const currentClick = e.currentTarget;\r\n                    currentClick.closest('.popup').classList.remove('open');\r\n                    (0,_enable_scroll_js__WEBPACK_IMPORTED_MODULE_1__.enableScroll)();\r\n                });\r\n            });\r\n        }\r\n    });\r\n});\r\n\r\n\r\n\r\n// for (let item of assortmentItem) {\r\n//     item.addEventListener('click', (e) => {\r\n//         popup.classList.add('open');\r\n//         disableScroll();\r\n//         popupClose.addEventListener('click', () => {\r\n//             popup.classList.remove('open');\r\n//             enableScroll();\r\n//         });\r\n//         areaClose.addEventListener('click', () => {\r\n//             popup.classList.remove('open');\r\n//             enableScroll();\r\n//         });\r\n//     });\r\n// }\r\n\n\n//# sourceURL=webpack://gulp/./src/js/popup.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\nconst header = document.querySelector('[data-header]');\r\nconst title = document.querySelector('[data-title]');\r\n\r\n\r\nif (header) {\r\n  var distance = 0;\r\n  var distanceX = 0;\r\n  var screenWidth = 0;\r\n  window.onscroll = function(e) {\r\n    screenWidth = window.screen.width;\r\n    distance += window.scrollY - distance;\r\n    if (distance>=24) {\r\n      header.classList.add(\"header--visible\")\r\n      title.classList.add('header__title--visible')\r\n    } else {\r\n      header.classList.remove(\"header--visible\")\r\n      title.classList.remove(\"header__title--visible\")\r\n    }\r\n\r\n    if (screenWidth>768) {\r\n      header.classList.remove(\"header--visible\")\r\n      title.classList.remove(\"header__title--visible\")\r\n    }\r\n  };\r\n}\n\n//# sourceURL=webpack://gulp/./src/js/scroll.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\nconst swiper = new Swiper('.swiper', {\r\n  slidesPerView: 3,\r\n  spaceBetween: 30,\r\n  loop: true,\r\n  navigation: {\r\n    nextEl: '.assortment-nav__next',\r\n    prevEl: '.assortment-nav__prev',\r\n  },\r\n});\n\n//# sourceURL=webpack://gulp/./src/js/swiper.js?");
